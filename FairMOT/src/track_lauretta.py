...
import os
from .consumer_lauretta import video_run
...
def eval_prop():
    ...
    for element in itertools.cycle(camera_list):
        ...
        video_run(camera_shift_time, prev_time, timer,results,frame_id)



def eval_prop_loop(body, message):
...
# removed from track_lauretta "while True:" -- Begin 
