...
from app.FairMOT.src.lib.models.networks.pose_dla_conv import get_pose_net as get_dla_conv
from app.FairMOT.src.lib.models.yolo import get_pose_net as get_pose_net_yolo
